...
$setting = collect(
   [
      ...
      'siteName' => 'SITE_NAME',
      'url' => 'URL',
      'siteUrl' => 'http://localhost:3000/%D0%9D%D0%BE%D0%B2%D0%B0%D1%8F%20%D0%BF%D0%B0%D0%BF%D0%BA%D0%B0/page.php',
      'metaImage' => 'https://gorizontclub.ru/wp-content/uploads/2021/12/vklink.jpg',
      'imageType' => 'image/jpeg',
      'metaImageWidth' => '1000',
      'metaImageHeight' => '1000',
      'publishedTime' => '2020-12-04T15:51:16+05:00',
      'updateTime' => '2022-08-31T17:11:37+05:00',
      'phoneUrl' => '+7-961-201-86-66',
      'phoneText' => '+7&#8209;961&#8209;201&#8209;86&#8209;66',
      'author' => 'lRulis',
   ]
);
...
<body>
         ...
         <div class="row">
            <div class="col-2">
               ...
               <div class="logo">
                  <a href="{{$setting['siteUrl']}}">
                     <div class="logo__img"><img src="img/gorizont_logo.png" title="{{$setting['siteName']}}" alt=""></div>
            ...
            <div class="col-2 col-nav">
               <nav>
                  <ul class="nav">
                     <li>
                        <a href="{{ route('category.index') }}">Главная</a>
                     </li>
                     <li>
                        <a href="{{ route('category.index') }}">Сплавы на байдарках</a>
                     </li>
                     <li>
                        <a href="{{ route('category.index') }}">Пешие походы</a>
                     </li>
                     <li>
                        <a class="active" href="{{ route('category.index') }}">Конные походы</a>
                     </li>
                     <li>
                        <a href="{{ route('category.index') }}">Каякинг</a>
                     </li>
                     <li>
                        <a href="{{ route('category.index') }}">Аренда снаряжения</a>
                     </li>
                  </ul>
               </nav>
            </div>
   ...
   <main>
      <div class="conteiner">
         <section>
            <article>
               <h1>Клуб «Горизонт» - походы и сплавы на байдарках из Тюмени</h1>
               <p>За душевным теплом и теплом от костров, за новыми местами, за новыми знаниями, за проверкой своих сил — идем с нами!

                  — От походов выходного дня до экспедиций
                  — Обучение каякингу, водный клуб: Ride Rivers
                  — Конные походы
                  — Сплавы на байдарках, каяках, рафтах
                  — Восхождения. Треккинг.
                  — Мультитуры
                  — Клубные мероприятия для тех, кто всегда в деле
               </p>
               <p>
                  Инструкторы: с группой идет 1-2 или более инструкторов, в зависимости от сложности похода и количества участников. Каждый инструктор имеет отличную подготовку и опыт превышающий уровень проводимых мероприятий.

                  Путешествуем от Тюмени и Урала до любого уголка мира.

                  Разрабатываем новые классные маршруты, ездим в места, в которых душа отдыхает, постоянно обновляем базу снаряжения, ищем лучшее жилье, готовим самую вкусную еду и вообще: поход — это для души.

                  Знаем, что времени на все не хватает! Мы уже всё продумали! Просто запишись

                  Отзывы участников: в нашей группе Вконтакте
               </p>
